...
from affix_package.constants import Clause, Negation, Pronoun
...
def show_colored_verb():
    try:
        ...
        text_widget.tag_configure("suffix_tag", foreground=suffix_color, font=("Helvetica", 16, "normal"))
...
# Text widget output
text_widget = tk.Text(root, height=2, width=40, font=("Helvetica", 16))
text_widget.pack(pady=10)

# Tags for color, font style
text_widget.tag_configure("root_tag", foreground="black", font=("Helvetica", 16, "normal"))
text_widget.tag_configure("error_tag", foreground="purple", font=("Helvetica", 16, "italic"))
